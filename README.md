...
The purpose of this project is to use exploratory data analysis techniques to find answers to the pollution data. 
The following description is obtained from the Coursera course: Exploratory Data Analysis (Assignment 2).
